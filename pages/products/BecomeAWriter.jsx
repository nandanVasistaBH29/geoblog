    ...
    checkout(
      {
        lineItems: [
          {
            price: "price_1M17R3SFs1QSUGsJuVFpdOH9",
            quantity: 1,
          },
        ],
      },
    ...
    >
      ...
      <div className="p-5">
        <h1 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          Get <span className="text-green-500 text-3xl">Writer</span> MemberShip
        </h1>

        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
          Be A Part Of Most Loved <span className="text-pink-400">Family</span>
          <b className="mx-2 text-green-200">Become A Writer</b>
        </p>
        <Link
          href="#"
